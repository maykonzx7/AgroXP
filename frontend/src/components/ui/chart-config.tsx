        ...
        {showConfig && (
          <div className="absolute inset-0 bg-white/90 backdrop-blur-sm p-4 flex flex-col animate-fade-in">
            <div className="flex justify-between items-center mb-4">
              <h4 className="font-medium">Configuração do gráfico</h4>
              <button 
                ...
                <div>
                  <label className="flex items-center text-sm font-medium mb-1">
                    <input 
                      ...
                      className="mr-2"
                    />
                    Exibir as dicas de ferramentas
                  </label>
                </div>
              </div>
              
              <div>
                <label className="block text-sm font-medium mb-2">Cores do gráfico</label>
