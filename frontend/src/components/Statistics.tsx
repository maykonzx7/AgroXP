...
import { TrendingUp, TrendingDown, BarChart3, PieChart, LineChart, Calendar, Filter, ArrowLeft, ChevronRight } from 'lucide-react';
...
const Statistics = () => {
  ...
  const getChartTitle = () => {
    switch (currentChart) {
      case 'yields': return 'Evolução dos rendimentos';
      case 'financial': return 'Análise financeira';
      case 'environmental': return 'Indicadores ambientais';
  ...
  const getChartDescription = () => {
    switch (currentChart) {
      ...
      case 'financial': return 'Análise detalhada das performances financeiras';
      case 'environmental': return 'Acompanhamento dos indicadores de performance ambiental';
      default: return 'Dados estatísticos da sua exploração';
    }
  };
