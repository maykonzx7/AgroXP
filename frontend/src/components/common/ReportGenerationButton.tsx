...
const ReportGenerationButton: React.FC<ReportGenerationButtonProps> = ({
  ...
  // Determinar quais formatos exibir
  ...
  // Se temos um último formato gerado e ele está nos nossos formatos disponíveis, colocá-lo primeiro
        ...
        {sortedFormats.map(format => (
          ...
          >
            ...
            {lastGeneratedFormat === format && (
              <span className="ml-2 text-xs text-muted-foreground">(Recente)</span>
            )}
          </DropdownMenuItem>
        ))}
      </DropdownMenuContent>
