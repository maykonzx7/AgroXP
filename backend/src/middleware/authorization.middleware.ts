...
export const authorizeFarmAccess = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const authorizeParcelAccess = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const user = (req as any).user;
